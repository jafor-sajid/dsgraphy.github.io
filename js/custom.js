...
---------------------------------------------------*/
  ...
  logo
---------------------------------------------------*/
if ($('.navbar-header .logo-container .logo-wrap img').length) {
  var scrollTrigger = 4, // px
      backToToplogo = function() {
          var scrollTop = $(window).scrollTop();
          if (scrollTop > scrollTrigger) {
              $('.navbar-header .logo-container .logo-wrap img').addClass('show');
          } else {
              $('.navbar-header .logo-container .logo-wrap img').removeClass('show');
          }
      };
  backToToplogo();
  $(window).on('scroll', function() {
  ...
  $('.navbar-header .logo-container .logo-wrap img').on('click', function(e) {
      e.preventDefault();
      $('html,body').animate({
          scrollTop: 0
      }, 700);
